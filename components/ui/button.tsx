  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        primaryOutline: "active:shadow-[inset_0_-2px_2px_rgba(0,0,0,0.1)]  bg-white text-sky-500 hover:bg-slate-100",
        secondary: "bg-green-400 text-primary-foreground hover:bg-green-400/90 border-green-500 border-b-4 active:border-b-0",
        secondaryOutline: "active:shadow-[inset_0_-2px_2px_rgba(0,0,0,0.1)]  bg-white text-green-500 hover:bg-green-100",
        danger: "bg-rose-400 text-primary-foreground hover:bg-rose-400/90 border-rose-500 border-b-4 active:border-b-0",
        dangerOutline: "active:shadow-[inset_0_-2px_2px_rgba(0,0,0,0.1)]  bg-white text-rose-500 hover:bg-rose-100",
        super: "bg-indigo-400 text-primary-foreground hover:bg-indigo-400/90 border-indigo-500 border-b-4 active:border-b-0",
        superOutline: "active:shadow-[inset_0_-2px_2px_rgba(0,0,0,0.1)]  bg-white text-indigo-500 hover:bg-indigo-100",
        ghost: "bg-slate-100 text-slate-300 border-transparent border-0",
        sidebar: "bg-sky-500/15 text-sky-500 border-2 border-transparent hover:bg-sky-500/20 transition-none",
